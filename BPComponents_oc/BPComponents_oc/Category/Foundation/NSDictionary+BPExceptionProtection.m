...
+ (void)load
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        SEL swizzledInstanceInitSelectorDictionaryM = @selector(initWithObjectsAndKeysSafeDicionary:);
        ...
        SEL swizzledClassInitSelectorDictionaryM = @selector(dictionaryWithObjectsAndKeysSafeDicdionary:);
        ...
        SEL swizzledInstanceInitSelectorPlaceholderDictionary = @selector(initWithObjectsAndKeysSafeDicionary:);
        ...
        SEL swizzledClassInitSelectorPlaceholderDictionary = @selector(dictionaryWithObjectsAndKeysSafeDicdionary:);
        ...
        SEL swizzledInstanceInitSelectorDictionaryI = @selector(initWithObjectsAndKeysSafeDicionary:);
        ...
        SEL swizzledClassInitSelectorDictionaryI = @selector(dictionaryWithObjectsAndKeysSafeDicdionary:);
...
- (instancetype)initWithObjectsAndKeysSafeDicionary:(id)firstObj,...
{
    NSMutableArray *validArgs = [NSMutableArray array];
    if (nil == firstObj) {
        return [self initWithObjectsAndKeysSafeDicionary:nil];
    }
...
+ (instancetype)dictionaryWithObjectsAndKeysSafeDicdionary:(id)firstObj, ...
{
    NSMutableArray *validArgs = [NSMutableArray array];
    if (nil == firstObj) {
        return [self dictionaryWithObjectsAndKeysSafeDicdionary:nil];
    }
