#
#  Be sure to run `pod spec lint WPProject.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "BPComponents_oc"
  s.version      = "0.0.1"
  s.summary      = "BPComponents_oc."
  ...
  s.homepage     = "https://github.com/wupeng4321/BPComponents_oc.git"
  ...
  s.author             = { "wupeng4321" => "wupeng_4321@163.com" }
  # Or just: s.author    = "wupeng4321"
  # s.authors            = { "wupeng4321" => "wupeng_4321@163.com" }
  # s.social_media_url   = "http://twitter.com/wupeng4321"
  ...
  s.source       = { :git => "https://github.com/wupeng4321/BPComponents_oc.git", :tag => "#{s.version}" }
